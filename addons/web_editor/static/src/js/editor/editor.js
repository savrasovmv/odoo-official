    ...
    cancel: function (reload) {
        ...
        return new Promise(function(resolve, reject) {
            if (!rte.history.getEditableHasUndo().length) {
                ...
                var confirm = Dialog.confirm(this, _t("Если вы отмените текущие правки, все несохраненные изменения будут потеряны. Вы можете отменить, чтобы вернуться в режим редактирования."), {
