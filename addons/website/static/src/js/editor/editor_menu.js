    ...
    cancel: function (reload) {
        ...
        var def = new Promise(function (resolve, reject) {
            if (!self.wysiwyg.isDirty()) {
                ...
                var confirm = Dialog.confirm(self, _t("Если вы отмените текущие правки, все несохраненные изменения будут потеряны. Вы можете отменить, чтобы вернуться в режим редактирования."), {
